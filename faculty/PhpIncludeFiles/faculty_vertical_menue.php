...
<div id="adminVMenuItem1" class="links">
	<a class="adminVMenuItemLInk" href="<?php echo constant("HOST11").'/faculty/index.php'?>">Home</a>
</div>
<div id="adminVMenuItem2" class="links">
	<a class="adminVMenuItemLInk" href="<?php echo constant("HOST11").'/faculty/change_pass.php'?>">Change Password</a>
</div>
